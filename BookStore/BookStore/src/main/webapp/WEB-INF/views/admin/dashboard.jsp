        ...
        <div class="row">
                    ...
                    <div class="mt-4 pt-3 border-top border-secondary">
                        <div class="d-flex align-items-center text-white mb-3">
                            <div class="bg-primary rounded-circle d-flex align-items-center justify-content-center me-2" style="width: 40px; height: 40px;">
                                <span class="fw-bold">
                                    <%= user.getFirstName() != null ? user.getFirstName().charAt(0) : 'A' %>
                                </span>
                            </div>
                            <div>
                                <div class="fw-bold">
                                    <%= user.getFirstName() != null ? user.getFirstName() + " " + user.getLastName() : "Admin User" %>
                                </div>
            ...
            <div class="col-md-9 col-lg-10 main-content">
                <div class="container-fluid py-4">
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <h1 class="h3 mb-1">Welcome back, <%= user.getFirstName() != null ? user.getFirstName() : "Admin" %>!</h1>
                            <p class="text-muted">Here's what's happening with your bookstore today.</p>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    <div class="activity-item">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <div class="fw-bold">New seller registered</div>
                                    ...
                                    <div class="activity-item">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <div class="fw-bold">Order #10239 completed</div>
                                    ...
                                    <div class="activity-item">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <div class="fw-bold">New promotion "Summer Sale" activated</div>
                                    ...
                                    <div class="activity-item">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                <div class="fw-bold">New review posted for "Clean Code"</div>
